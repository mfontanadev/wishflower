...
function testServices()
{
	...
	callWebService('services/wishflowerGetById?id=10');
	//callWebService('services/errorPageGetAll');
	//callWebService('services/errorPageGetById');

}

function callWebService(servicePath)
{
	console.log("CallWebService request:" + servicePath);

	$.ajax({
	   url: '//localhost:5000/' + servicePath,
	   ...
	   {
	   		console.log("CallWebService response:" + JSON.stringify(data));
	   },
	   type: 'GET'
	});
}
