...
WishflowerMenuActivity.prototype.createControls = function ()
{
	...
	this.m_btnGotoLadybugFilterImageTestActivity.initButtonStyle(tmpCanvas, getCX(tw, bw), 50 + bh * 1.5 * 4, bw, bh, "Ladybug image filter");
	...
	this.m_btnGotoHelpTestActivity.initButtonStyle(tmpCanvas, getCX(tw, bw), 50 + bh * 1.5 * 5, bw, bh, "Help demo");
