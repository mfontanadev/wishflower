module.exports = function(app)
{
	...
	app.get('/lib/chel-1.0.1-dist/js/storageManager.js', 
		function (req, res) {res.sendFile(__dirname + '/js/storageManager.js');});

	app.get('/lib/chel-1.0.1-dist/js/viewManager.js', 
		function (req, res) {res.sendFile(__dirname + '/js/viewManager.js');});

	console.log("   lib/chel-1.0.1-dist/index.js: OK");
}
