...
function KeyboardManager()
{
	...
	KeyboardManager.prototype.initWithDefaultCallbaks = function (_eventPropagation)
	{
		...
		ownerKeyboardManager = this;

		document.onkeydown = function(event) 
		{
			ownerKeyboardManager.keyDown(event.keyCode);

			return ownerKeyboardManager.m_eventPropagation;
		};
		
		document.onkeyup = function(event) 
		{
			ownerKeyboardManager.keyUp(event.keyCode);
