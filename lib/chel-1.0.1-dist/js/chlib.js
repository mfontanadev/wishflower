...
{ 
	...
	chCanvas.prototype.performResize = function ()
	{
		...
		if (this.m_window.innerHeight <= this.m_window.innerWidth)
		{
			...
			m_scaleX = this.m_canvasWidth / this.m_canvas.width;
			m_scaleY = this.m_canvasHeight / this.m_canvas.height;
		}
		else
		{
