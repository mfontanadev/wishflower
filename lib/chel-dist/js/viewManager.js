...
ViewManager.prototype.initializeGlobalConfig = function ()
{
};

ViewManager.prototype.getGlobalConfigInstance = function ()
{
	if (this.isGlobalConfigCreated() === false)
	{
		this.m_globalConfig = new Globals();
	}

	return this.m_globalConfig; 
};

ViewManager.prototype.isGlobalConfigCreated = function ()
{
	return (typeof this.m_globalConfig !== 'undefined' && this.m_globalConfig !== null);
}
...
ViewManager.prototype.navigateTo = function (_id)
{
	...
	if (this.isCurrentActivityValid() === true)
	{
		msglog("ENTER TO: " + this.getCurrentActivity().getActivityName());
