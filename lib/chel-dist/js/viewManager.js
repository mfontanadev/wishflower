...
ViewManager.prototype.animationCycle = function ()
{
	...
	if (C_LOG === true)
	{
 		elapsedTime = (this.m_currentDate - this.m_startTime);
		message += 'Mouse position: ' + this.m_mouseManager.m_mousePosX + ',' + this.m_mouseManager.m_mousePosY + "," +  this.m_mouseManager.m_mouseClick + ", fps=" + Math.round(elapsedTime,2);
